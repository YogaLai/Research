...
# parser.add_argument('--predicted_disp', type=str,   help='path to estimated disparities',      required=True)
...
def eval(epoch, pred_disparities, writer):
    ...
    writer.add_scalar('abs_rel', abs_rel.mean(), epoch)
...
if __name__ == '__main__':
    ...
    for k, v in npy_dict:
        pred_disparities = np.load(v)
        eval(k, pred_disparities, writer)