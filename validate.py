    ...
    with torch.no_grad():
        with tqdm(total=len(CycleLoader.dataset)) as pbar:
            for batch_idx, (left_image_1, left_image_2, right_image_1, right_image_2) in enumerate(CycleLoader):
                ...
                writer.add_scalar('Val_iter/rec_loss', image_loss.data, iteration)
                writer.add_scalar('Val_iter/rec_loss_2', image_loss_2.data, iteration)
                writer.add_scalar('Val_iter/smooth_loss', disp_gradient_loss.data, iteration)
                writer.add_scalar('Val_iter/smooth_loss_2', disp_gradient_loss_2.data, iteration)
                writer.add_scalar('Val_iter/lr_consistency', lr_loss.data, iteration)
                iteration += 1
