...
class PWCDCNet(nn.Module):
    ...
    def __init__(self, md=4):
        ...
        self.conv1aaa = myconv(16,  16, kernel_size=3, stride=1)
        ...
        self.conv2aaa = myconv(32,  32, kernel_size=3, stride=1)
        ...
        self.conv3aaa = myconv(64,  64, kernel_size=3, stride=1)
        ...
        self.conv4aaa = myconv(96,  96, kernel_size=3, stride=1)
        ...
        self.conv5aaa = myconv(128,128, kernel_size=3, stride=1)
        ...
        self.conv6aaa = myconv(196,196, kernel_size=3, stride=1)
    ...
    def forward(self,x):
        ...
        c11 = self.conv1b(self.conv1aaa(self.conv1aa(self.conv1a(im1))))
        c21 = self.conv1b(self.conv1aaa(self.conv1aa(self.conv1a(im2))))
        c12 = self.conv2b(self.conv2aaa(self.conv2aa(self.conv2a(c11))))
        c22 = self.conv2b(self.conv2aaa(self.conv2aa(self.conv2a(c21))))
        c13 = self.conv3b(self.conv3aaa(self.conv3aa(self.conv3a(c12))))
        c23 = self.conv3b(self.conv3aaa(self.conv3aa(self.conv3a(c22))))
        c14 = self.conv4b(self.conv4aaa(self.conv4aa(self.conv4a(c13))))
        c24 = self.conv4b(self.conv4aaa(self.conv4aa(self.conv4a(c23))))
        c15 = self.conv5b(self.conv5aaa(self.conv5aa(self.conv5a(c14))))
        c25 = self.conv5b(self.conv5aaa(self.conv5aa(self.conv5a(c24))))
        c16 = self.conv6b(self.conv6aaa(self.conv6a(self.conv6aa(c15))))
        c26 = self.conv6b(self.conv6aaa(self.conv6a(self.conv6aa(c25))))
