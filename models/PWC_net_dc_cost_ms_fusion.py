...
def convbn(in_planes, out_planes, kernel_size=3, stride=1, padding=1):
    return nn.Sequential(
...
class MultiScaleFeatureFusion(nn.Module):
    def __init__(self):
        ...
        self.upconv3_2 = convbn(32, 32, kernel_size=1, padding=0) # level 3 to level 2
        self.upconv4_2 = convbn(32, 32, kernel_size=1, padding=0) # level 4 to level 2
        ...
        self.upconv4_3 = convbn(32, 32, kernel_size=1, padding=0) 
        self.downconv2_3 = convbn(32, 32, kernel_size=3, padding=1, stride=2) 
        ...
        self.upconv5_4 = convbn(32, 32, kernel_size=1, padding=0) 
        self.downconv3_4 = convbn(32, 32, kernel_size=3, padding=1, stride=2) 
...
class PWCDCNet(nn.Module):
    ...
    """
    def __init__(self, md=3, attn_match=False, relation='dot-product'):
        """
    ...
    def forward(self,x):
        ...
        corr6 = compute_dc_cost(c16, c26, self.matchnet6, self.md, self.relation)
        ...
        corr4 = compute_dc_cost(c14, warp4, self.matchnet4, self.md, self.relation)
        ...
        corr3 = compute_dc_cost(c13, warp3, self.matchnet3, self.md, self.relation)
        ...
        corr2 = compute_dc_cost(c12, warp2, self.matchnet2, self.md, self.relation)
