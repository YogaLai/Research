...
from utils.correltaiton import MatchingNet, DICL_cost
...
class PWCDCNet(nn.Module):
    ...
    def __init__(self, md=3):
        ...
        self.conv1a  = myconv(3,   16, kernel_size=3, stride=2, padding=1)
        # self.conv1aa = myconv(16,  16, kernel_size=3, stride=1)
        self.conv1b  = myconv(16,  32, kernel_size=3, stride=1)
        self.conv2a  = myconv(16,  32, kernel_size=3, stride=2, padding=1)
        # self.conv2aa = myconv(32,  32, kernel_size=3, stride=1)
        self.conv2b  = myconv(32,  32, kernel_size=3, stride=1)
        self.conv3a  = myconv(32,  64, kernel_size=3, stride=2, padding=1)
        # self.conv3aa = myconv(64,  64, kernel_size=3, stride=1)
        self.conv3b  = myconv(64,  32, kernel_size=3, stride=1)
        self.conv4a  = myconv(64,  96, kernel_size=3, stride=2, padding=1)
        # self.conv4aa = myconv(96,  96, kernel_size=3, stride=1)
        self.conv4b  = myconv(96,  32, kernel_size=3, stride=1)
        self.conv5a  = myconv(96, 128, kernel_size=3, stride=2, padding=1)
        # self.conv5aa = myconv(128,128, kernel_size=3, stride=1)
        self.conv5b  = myconv(128,32, kernel_size=3, stride=1)
        self.conv6aa = myconv(128,196, kernel_size=3, stride=2, padding=1)
        # self.conv6a  = myconv(196,196, kernel_size=3, stride=1)
        self.conv6b  = myconv(196,32, kernel_size=3, stride=1)

        # self.corr    = Correlation(pad_size=md, kernel_size=1, max_displacement=md, stride1=1, stride2=1, corr_multiply=1)
        self.matching_net6 = MatchingNet()
        self.matching_net5 = MatchingNet()
        self.matching_net4 = MatchingNet()
        self.matching_net3 = MatchingNet()
        self.matching_net2 = MatchingNet()
        ...
        self.upsample_conv = deconv(2, 2, kernel_size=6, stride=4, padding=1)
    ...
    def forward(self,x):
        ...
        # c11 = self.conv1aa(self.conv1a(im1))
        # c21 = self.conv1aa(self.conv1a(im2))
        # c12 = self.conv2aa(self.conv2a(c11))
        # c22 = self.conv2aa(self.conv2a(c21))
        # c13 = self.conv3aa(self.conv3a(c12))
        # c23 = self.conv3aa(self.conv3a(c22))
        # c14 = self.conv4aa(self.conv4a(c13))
        # c24 = self.conv4aa(self.conv4a(c23))
        # c15 = self.conv5aa(self.conv5a(c14))
        # c25 = self.conv5aa(self.conv5a(c24))
        # c16 = self.conv6a(self.conv6aa(c15))
        # c26 = self.conv6a(self.conv6aa(c25))
        ...
        c15 = self.conv5a(c14)
        c25 = self.conv5a(c24)
        c16 = self.conv6aa(c15)
        c26 = self.conv6aa(c25)
        ...
        corr6 = DICL_cost(c16, c26, self.matching_net6) 
        ...
        corr5 = DICL_cost(c15, warp5, self.matching_net5) 
        ...
        corr4 = DICL_cost(c14, warp4, self.matching_net4)  
        ...
        corr3 = DICL_cost(c13, warp3, self.matching_net3) 
        ...
        corr2 = DICL_cost(c12, warp2, self.matching_net2)
