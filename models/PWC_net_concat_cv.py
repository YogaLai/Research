...
from utils.correltaiton import MatchingNet, compute_cost
...
class PWCDCNet(nn.Module):
    ...
    def forward(self,x):
        ...
        corr6 = compute_cost(c16, c26, self.matchnet)
        corr6 = self.dap(corr6)
        ...
        corr5 = compute_cost(c15, warp5, self.matchnet)
        corr5 = self.dap(corr5)
        ...
        corr4 = compute_cost(c14, warp4, self.matchnet)
        corr4 = self.dap(corr4)
        ...
        corr3 = compute_cost(c13, warp3, self.matchnet)
        corr3 = self.dap(corr3) 
        ...
        corr2 = compute_cost(c12, warp2, self.matchnet)
        corr2 = self.dap(corr2) 
