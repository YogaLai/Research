...
from utils.correltaiton import MatchingNetSmall, MatchingNetSmallAttn, compute_stereo_cost
...
class PWCDCNet(nn.Module):
    ...
    def __init__(self, md=3, attn_match=False, attn_dap=False, dcn=False):
        ...
        if attn_dap:
            ...
            self.dap6 = DAP(nd) #$ 2*6+1 + 2*1+1 (U=6, V=1)
            self.dap5 = DAP(nd)
            self.dap4 = DAP(nd)
            self.dap3 = DAP(nd)
            self.dap2 = DAP(nd)
    ...
    def forward(self,x):
        ...
        corr6 = compute_stereo_cost(c16, c26, self.matchnet6)
        ...
        corr5 = compute_stereo_cost(c15, warp5, self.matchnet5)
        ...
        corr4 = compute_stereo_cost(c14, warp4, self.matchnet4)
        ...
        corr3 = compute_stereo_cost(c13, warp3, self.matchnet3)
        ...
        corr2 = compute_stereo_cost(c12, warp2, self.matchnet2)
