...
class PWCDCNet(nn.Module):
    ...
    def __init__(self, md=4):
        ...
        self.sparse_corr    = Correlation(pad_size=md+2, kernel_size=1, max_displacement=md+2, stride1=2, stride2=1, corr_multiply=1)
    ...
    def forward(self,x):
        ...
        corr2 = nn.UpsamplingBilinear2d(size=(c12.size(2), c12.size(3)))(corr2)
