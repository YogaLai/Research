...
import os.path
from models.UFlow import normalize_features, upsample2d_flow_as

from utils.correltaiton import MatchingResNet, compute_dc_cost
...
class PWCDCNet(nn.Module):
    ...
    def __init__(self, md=3, attn_match=False):
        ...
        self.matchnet2 = MatchingResNet()
        self.matchnet3 = MatchingResNet()
        self.matchnet4 = MatchingResNet()
        self.matchnet5 = MatchingResNet()
        self.matchnet6 = MatchingResNet()
        ...
        bam = DualAttention(nd)
        self.dap6 = DAP(bam, md=md)
        self.dap5 = DAP(bam, md=md)
        self.dap4 = DAP(bam, md=md)
        self.dap3 = DAP(bam, md=md)
        self.dap2 = DAP(bam, md=md)

        # bam2 = DualAttention(nd)
        # bam3 = DualAttention(nd)
        # bam4 = DualAttention(nd)
        # bam5 = DualAttention(nd)
        # bam6 = DualAttention(nd)
        # self.dap2 = DAP(bam2, md=md)
        # self.dap3 = DAP(bam3, md=md)
        # self.dap4 = DAP(bam4, md=md)
        # self.dap5 = DAP(bam5, md=md)
        # self.dap6 = DAP(bam6, md=md)
    ...
    def forward(self,x):
        ...
        corr6 = compute_dc_cost(c16, c26, self.matchnet6, self.md)
        ...
        corr5 = compute_dc_cost(c15, warp5, self.matchnet5, self.md)
        ...
        corr4 = compute_dc_cost(c14, warp4, self.matchnet4, self.md)
        ...
        corr3 = compute_dc_cost(c13, warp3, self.matchnet3, self.md)
        ...
        corr2 = compute_dc_cost(c12, warp2, self.matchnet2, self.md)
