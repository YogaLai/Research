...
class PWCDCNet(nn.Module):
    ...
    def __init__(self, md=4):
        ...
        self.corr6    = VecAttn(1, 192, 192//16, 192)
        self.corr5    = VecAttn(1, 128, 128//16, 128)
        self.corr4    = VecAttn(1, 96, 96//16, 96)
        self.corr3    = VecAttn(1, 64, 64//16, 64)
        self.corr2    = VecAttn(1, 32, 32//16, 32)
