...
from .lib.LCV import LearnableCorrBlock
...
class PWCDCNet(nn.Module):
    ...
    def __init__(self, md=4):
        ...
        self.corr2    = LearnableCorrBlock(32)
        self.corr3    = LearnableCorrBlock(64)
        self.corr4    = LearnableCorrBlock(96)
        self.corr5    = LearnableCorrBlock(128)
        self.corr6    = LearnableCorrBlock(196)
