...
class PWCDCNet(nn.Module):
    ...
    def __init__(self, md=4):
        ...
        self.cascade_attn60 = DualAttention(128)
        self.cascade_attn61 = DualAttention(128)
        self.cascade_attn62 = DualAttention(96)
        self.cascade_attn63 = DualAttention(64)
        self.cascade_attn64 = DualAttention(32)
        ...
        self.cascade_attn50 = DualAttention(128)
        self.cascade_attn51 = DualAttention(128)
        self.cascade_attn52 = DualAttention(96)
        self.cascade_attn53 = DualAttention(64)
        self.cascade_attn54 = DualAttention(32)

        self.cascade_attn40 = DualAttention(128)
        self.cascade_attn41 = DualAttention(128)
        self.cascade_attn42 = DualAttention(96)
        self.cascade_attn43 = DualAttention(64)
        self.cascade_attn44 = DualAttention(32)


        self.cascade_attn30 = DualAttention(128)
        self.cascade_attn31 = DualAttention(128)
        self.cascade_attn32 = DualAttention(96)
        self.cascade_attn33 = DualAttention(64)
        self.cascade_attn34 = DualAttention(32)

        self.cascade_attn20 = DualAttention(128)
        self.cascade_attn21 = DualAttention(128)
        self.cascade_attn22 = DualAttention(96)
        self.cascade_attn23 = DualAttention(64)
        self.cascade_attn24 = DualAttention(32)
    ...
    def forward(self,x):
        ...
        x = self.cascade_attn60(x)
        x = torch.cat((x, corr6), 1)
        # x = torch.cat((self.conv6_0(corr6), corr6),1)
        # x = self.conv6_0(corr6)
        x = self.conv6_1(x)
        x = self.cascade_attn61(x)
        x = self.conv6_2(x)
        x = self.cascade_attn62(x)
        x = self.conv6_3(x)
        x = self.cascade_attn63(x)
        x = self.conv6_4(x)
        x = self.cascade_attn64(x)
        ...
        x = self.conv5_0(x)
        x = self.cascade_attn50(x)
        x = self.conv5_1(x)
        x = self.cascade_attn51(x)
        x = self.conv5_2(x)
        x = self.cascade_attn52(x)
        x = self.conv5_3(x)
        x = self.cascade_attn53(x)
        x = self.conv5_4(x)
        x = self.cascade_attn54(x)
        ...
        x = self.conv4_0(x)
        x = self.cascade_attn40(x)
        x = self.conv4_1(x)
        x = self.cascade_attn41(x)
        x = self.conv4_2(x)
        x = self.cascade_attn42(x)
        x = self.conv4_3(x)
        x = self.cascade_attn43(x)
        x = self.conv4_4(x)
        x = self.cascade_attn44(x)
        ...
        x = self.conv3_0(x)
        x = self.cascade_attn30(x)
        x = self.conv3_1(x)
        x = self.cascade_attn31(x)
        x = self.conv3_2(x)
        x = self.cascade_attn32(x)
        x = self.conv3_3(x)
        x = self.cascade_attn33(x)
        x = self.conv3_4(x)
        x = self.cascade_attn34(x)
        ...
        x = self.conv2_0(x)
        x = self.cascade_attn20(x)
        x = self.conv2_1(x)
        x = self.cascade_attn21(x)
        x = self.conv2_2(x)
        x = self.cascade_attn22(x)
        x = self.conv2_3(x)
        x = self.cascade_attn23(x)
        x = self.conv2_4(x)
        x = self.cascade_attn24(x)
